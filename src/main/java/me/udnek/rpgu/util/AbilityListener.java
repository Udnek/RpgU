...
//                customItem.getComponents().getOrDefault(RPGUComponents.ACTIVE_ABILITY_ITEM).onRightClick(customItem, event));
    }

    @EventHandler
    public void abilityStopUsing(PlayerStopUsingItemEvent event){
//        CustomItem.consumeIfCustom(event.getItem(), customItem ->
//                customItem.getComponents().getOrDefault(Components.ACTIVE_ABILITY_ITEM).onStopUsing(customItem, event));
    }

    @EventHandler
    public void abilityConsume(PlayerItemConsumeEvent event){
//        CustomItem.consumeIfCustom(event.getItem(), customItem ->
//                customItem.getComponents().getOrDefault(Components.ACTIVE_ABILITY_ITEM).onConsume(customItem, event));
    }
...
//                     customItem.getComponents().getOrDefault(Components.EQUIPPABLE_ITEM).getPassives(passive -> {
