...
public class Attributes{
    ...
    public static final CustomAttribute PROJECTIL_DAMAGE_MULTIPLIER;
    ...
    static {
        ...
        PROJECTIL_DAMAGE_MULTIPLIER = register(new ProjectileDamageMultiplierAttribute());
        PROJECTILE_SPEED = register(new ProjectileSpeedAttribute());
