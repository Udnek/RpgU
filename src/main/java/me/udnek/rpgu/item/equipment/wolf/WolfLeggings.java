...
public class WolfLeggings extends WolfArmor {
    @Override
    public @NotNull String getRawId() {return "wolf_leggings";}
    ...
    public void initializeAttributes(@NotNull ItemMeta itemMeta) {
        ...
        AttributeManaging.applyDefaultArmorAttribute(itemMeta, Material.LEATHER_LEGGINGS);
    }
